      ...
      >
        <div className="space-y-8">
          ...
          <motion.div variants={itemVariants}>
            <Button
              size="lg"
              className="inline-flex items-center gap-3 px-8 py-4 bg-primary text-surface-dark font-display font-bold text-sm tracking-widest uppercase rounded shadow-neon hover:bg-blue-500 hover:text-white transition-all transform hover:-translate-y-1 duration-300"
              asChild
            >
              <motion.a
                href="#"
          ...
          >
            <div className="space-y-3">
              <span className="text-xs font-display tracking-widest uppercase text-text-muted-light dark:text-text-muted-dark">
                Find me on
              </span>
              <div className="flex gap-3 flex-wrap">
                {[
                  ...
                  <motion.a
                    key={social.icon}
                    className="w-12 h-12 flex items-center justify-center rounded bg-surface-light dark:bg-surface-dark shadow-lg shadow-gray-200/50 dark:shadow-none hover:bg-primary hover:text-white dark:hover:bg-primary dark:hover:text-white transition-all transform hover:-translate-y-1"
                    href={social.href}
                    target="_blank"
        ...
        >
          <motion.div
            ref={imageRef}
            className="relative w-full max-w-md aspect-[4/5] bg-surface-light dark:bg-surface-dark rounded-2xl shadow-card overflow-hidden group"
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center z-0 pointer-events-none">
              <span className="text-4xl md:text-5xl font-display font-black uppercase text-outline tracking-widest opacity-30">
                Developer
              </span>
            </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-15"></div>
